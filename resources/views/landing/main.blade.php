            ...
            <div class="hero-inner">
                <div class="hero-copy">
                    ...
                    <p class="hero-paragraph">
                        Este servidor processa todas as informações utilizadas no aplicativo eMazaGame. Somente usuários permitidos tem acesso a área restrita deste servidor. AG
                    </p>
                    <div class="hero-cta">
                ...
                <div class="pricing-tables-wrap">
                    ...
                    <div class="pricing-table">
                        <div class="pricing-table-inner is-revealing">
                            <div class="pricing-table-main">
                                <div class="pricing-table-header pb-24">
                                    <div class="pricing-table-price"><span class="pricing-table-price-currency h2">MZN</span><span class="pricing-table-price-amount h1">129</span><span class="text-xs">/mês</span></div>
                                </div>
    ...
    <section class="cta section">
        <div class="container">
            <div class="cta-inner section-inner">
                <h3 class="section-title mt-0">Quital baixar agora?</h3>
                <div class="cta-cta">
